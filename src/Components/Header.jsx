...
function Header() {
  ...
  return (
    <div className="m-auto mb-2 fixed w-[100%] top-0 z-[100]">
      ...
      {/* Navbar menu */}
      <div className={`lg:flex lg:flex-col lg:items-center ${navToggle ? 'block' : 'hidden'} ${showWhiteBackground ? 'bg-white'   : ''}`}>
        {/* Top section */}
        <div className="lg:flex lg:justify-between lg:items-center pl-[39px] bg-white  py-2 items-center lg:w-full" style={{ boxShadow: "0 1px 2px rgba(0, 0, 0, 0.25)" }}>
          <div>
          ...
          <div className="lg:flex items-center lg:w-[43%] justify-evenly mt-4 lg:mt-0">
            <div className="relative">
              <div className={`p-2 rounded-full flex items-center justify-center ${isVisible ? 'shadow-lg' : ''} w-fit`}>
      ...
      <div className="lg:flex lg:justify-between lg:items-center w-[100%] p-4 items-center lg:bg-transparent bg-white">
        ...
        <div className="lg:flex items-center lg:w-[50%] justify-evenly mt-4 lg:mt-0">
          <Link to="#" className="lg:inline block font-medium  m-2">K-12</Link>
          <Link to="#" className="lg:inline block font-medium  m-2">Higher ED</Link>
          <Link to="#" className="lg:inline block font-medium  m-2">Professional ED</Link>
