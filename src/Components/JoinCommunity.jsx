...
const JoinCommunity = () => {
  return (
    <div className="container m-auto mt-20">
      <div className="lg:flex justify-around w-[85%] rounded-xl bg-[#091D4F] p-5 m-auto items-center">
        <div className="lg:w-[35%] w-[95%] m-auto lg:m-0 lg:text-left text-center">
          <h3 className="text-[14px] font-semibold text-white">
            OVER 2 MILLION STRONG
          </h3>
          <h2 className="lg:text-[40px] text-[30px] font-semibold text-white">
            Join Our Community
          </h2>
          ...
          <button
            className="mt-8 px-6 w-fit rounded-full p-3 bg-[#fff] text-[#091D4F] font-semibold"
        ...
        <div>
          <img src={JoinImage} alt="" className="m-auto mt-5 lg:mt-0 lg:m-0" />
        </div>
      </div>
    </div>
  );
