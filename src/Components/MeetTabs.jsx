            ...
            <div className=" lg:flex justify-evenly items-center mt-16 m-auto lg:mx-0">
              ...
              <div className="container lg:w-[35%] w-[95%] m-auto mt-5 lg:m-0 lg:text-left text-center animate__animated  animate__backInRight">
                <img
                  src={Logo}
                  alt=""
                  className="m-auto lg:m-0 w-[244px] mb-[28px]"
                />
                ...
                <p className="text-[16px] text-[#143D50]">
                  Find all the tools you need for teaching and learning in one
                  place. Akademia by Jovanotti facilitates seamless connections
                  between teachers, students, and families, no matter where
          ...
          <div>
            <div className=" lg:flex justify-evenly items-center mt-16 m-auto lg:mx-0">
              ...
              <div className="container lg:w-[35%] w-[95%] m-auto mt-5 lg:m-0 lg:text-left text-center animate__animated  animate__backInRight">
                ...
                <p className="text-[16px] text-[#143D50]">
                  Akademia Studio is the central hub where both new and
                  experienced users can introduce themselves, edit content,
                  record sessions, follow courses, learn, and teach. Developed
                  by Jovanotti, this platform is designed to foster a
                  comprehensive and interactive learning environment. With
                  Akademia Studio, users can seamlessly engage in a wide range
                  of educational activities, making it an essential tool for
            ...
            <div className=" lg:flex justify-evenly items-center mt-16 m-auto lg:mx-0">
              <div className="animate__animated  animate__backInLeft">
                <img
                  src={Img3}
                  alt=""
                  className="m-auto lg:m-0  ml-[-15px] mb-[28px]"
                />
              </div>
              ...
              <div className="container lg:w-[35%] w-[95%] m-auto mt-5 lg:m-0 lg:text-left text-center animate__animated  animate__backInRight">
                ...
                <p className="text-[16px] text-[#143D50]">
                  FutureWise is a powerful tool designed to streamline the
                  adoption of educational technology and maximize its impact.
                  FutureWise enhances technology integration, enabling faculty
                  and students to seamlessly navigate new platforms. It also
                  provides robust evaluation tools to assess the effectiveness
                  of educational technologies, ensuring higher impact and
                  improved outcomes for all users. FutureWise is your
                  comprehensive solution for advancing edtech adoption and
