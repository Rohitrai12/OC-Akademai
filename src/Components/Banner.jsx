  ...
  return (
    <div className="container m-auto  Banner lg:h-[700px] h-[500px]">
      <div className="m-auto ">
        <div
          className="container px-10 py-14  rounded-2xl w-[95%] m-auto lg:m-0 lg:w-[500px] relative bg-[#fff] lg:left-60 animate__animated  animate__backInDown" 
          style={{ boxShadow: " 0px 20px 50px 10px rgba(20, 61, 80, 0.15)" }}
        >
          <img src={Logo} alt="" />
          <h1 className="lg:text-[46px] text-[35px] font-bold inika-bold text-[#091D4F] text-left">
            Yes, You Can <br />
